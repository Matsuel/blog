...
const OptionArticle = ({
    ...
    return (
        <ArticleLayout title={title}>
            ...
            <div className={styles.question}>- Comment et quand les notifications sont-elles envoyées en fonction des différents états (<span className={styles.bold}>OK</span>, <span className={styles.bold}>Attention</span>, <span className={styles.bold}>Critique</span>, <span className={styles.bold}>Inconnu</span>, <span className={styles.bold}>Prise en compte</span> lors d&apos;un événement, <span className={styles.bold}>Flapping</span> - oscillation entre plusieurs états, <span className={styles.bold}>Maintenance</span> - lors de la modification de l&apos;objet) ?</div>
            <div className={styles.question}>- Que se passe-t-il réellement lorsque l&apos;état d&apos;un objet change ? (Qui est alerté, qui doit intervenir ?)</div>
            <div className={styles.question}>- Comment le code est-il organisé, et comment doit-il être structuré ?</div>
            <div className={styles.question}>- Dois-je me limiter à modifier la partie du code qui m&apos;est assignée ou corriger également les erreurs rencontrées ?</div>
            ...
            <div className={styles.paragraphe}>- <span className={styles.bold}>L&apos;interface de configuration :</span> permet de configurer, créer, et récupérer des objets à superviser. On peut personnaliser le nom de l&apos;objet, sa description, les options de notification (quand je souhaite être averti), et le modèle de configuration dont l&apos;hôte peut hériter, notamment pour les options de notification. Des utilisateurs à notifier lors de certains états peuvent également être créés via cette interface, ainsi que des méthodes de notification (SMS, mail, etc.), offrant une grande flexibilité et personnalisation.</div>
            <div className={styles.paragraphe}>- <span className={styles.bold}>L&apos;interface de visualisation :</span> permet de consulter la liste de tous les éléments supervisés, l&apos;état actuel de chacun (pour chaque hôte, les tests hérités des modèles possèdent chacun un état consultable via cette interface), et d&apos;ajouter une période de prise en compte (acknowledge) pour chaque hôte. D&apos;autres pages sont disponibles, mais je n&apos;ai pas encore eu l&apos;occasion de les explorer en profondeur, comme :</div>
            <div className={styles.paragraphe}>- <span className={styles.bold}>La météo des services</span>, qui offre une vue d&apos;ensemble sur l&apos;état du parc informatique</div>
            <div className={styles.paragraphe}>- <span className={styles.bold}>Une page de widgets</span> permettant d&apos;organiser et de ranger chaque type d&apos;objet</div>
