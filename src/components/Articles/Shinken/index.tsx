...
const ShinkenArticle = ({
    ...
    return (
        <ArticleLayout title={title}>
            ...
            <div className={styles.paragraphe}> - <span className={styles.bold}>Synchronizer:</span> Permet de gérer l&apos;interface de configuration ainsi que les échanges avec la base de données </div>
            <div className={styles.paragraphe}> - <span className={styles.bold}>Arbiter:</span> Gère l&apos;ensemble de l&apos;architecture, il sert de &quot;chef d&apos;orchestre&quot;</div>
            <div className={styles.paragraphe}> - <span className={styles.bold}>Receiver:</span> Démon qui reçoit les requêtes effectuées via son API</div>
            <div className={styles.paragraphe}> - <span className={styles.bold}>Scheduler:</span> Récupère toutes les données venant du Poller, Reactionner ainsi que du Broker afin de les transmettre à l&apos;arbiter qui les enverra au Synchronizer</div>
            <div className={styles.paragraphe}> - <span className={styles.bold}>Puller:</span> Effectue tous les tests &quot;checks&quot; sur tous les éléments supervisées comme par exemple vérifier son accès à internet via un ping</div>
            <div className={styles.paragraphe}> - <span className={styles.bold}>Broker:</span> Gère l&apos;interface de visualisation (interface sur laquelle un utilisateur peut effectuer des actions et vérifier le bon fonctionnement des objets)</div>
            <div className={styles.paragraphe}> - <span className={styles.bold}>Reactionner:</span> Envoie les notifications si elles sont activées aux personnes à prévenir en cas de mauvais résultats de tests effectués par le Poller</div>
