        ...
        <div className={styles.Navbar_container} ref={navRef}>
            ...
            <div className={styles.Navbar_links}>
                {Links.map((link, index) => (
                    <Link key={link.label} href={link.href} target={link.target ? "_blank" : "_self"} className={styles.Navbar_link + " " + (activeLink === index ? styles.Navbar_linkActive : "")} onClick={() => setActiveLink(index)} >
                        {link.icon}
                        {link.label}
                    </Link>
                ))}
